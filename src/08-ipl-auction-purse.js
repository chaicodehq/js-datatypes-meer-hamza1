...
export function iplAuctionSummary(team, players) {
  // Your code here
  if(!team||typeof team !=="object"||team.purse<0||!Array.isArray(players)||players.length===0||!team.purse){
    return null;
  }
...
const byRole = players.reduce((acc,player)=>{acc[player.role]= (acc[player.role] || 0 ) + 1;
  return acc;
},{});
